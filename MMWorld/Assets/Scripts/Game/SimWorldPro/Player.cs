...
public class Player
{
    ...
    public Player(Scene scene_)
    {
        ...
        mgo.Enable();//激活游戏物体
        mgo.r.sprite = scene.sprites_player[0];//初始化玩家精灵
        mgo.r.material = scene.minimapMaterial;//初始化材质
        mgo.t.localScale = new Vector3(1, 1, 1);//初始化本地缩放
    }
    ...
    public void Draw()
    {
        ...
        mgo.t.position = p;//小地图游戏物体对象也贴在同一位置
    }
