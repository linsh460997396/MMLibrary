...
namespace MetalMaxSystem
{
    ...
    public class TextureAnalyzer : MonoBehaviour
    {
        ...
        public static bool CalculateSimilarityTorf(Color[] pixels1, Color[] pixels2, float similarity)
        {
            ...
            //Debug.Log($"ColorIndex {i}: R={pixels1[i].r}, G={pixels1[i].g}, B={pixels1[i].b}, A={pixels1[i].a}");
            //Debug.Log(string.Format("pixels1({0}, {1}, {2}, {3})", pixels1[1].r, pixels1[1].g, pixels1[1].b, pixels1[1].a));
            //Debug.Log(string.Format("pixels2({0}, {1}, {2}, {3})", pixels2[1].r, pixels2[1].g, pixels2[1].b, pixels2[1].a));
            return torf;
        }
